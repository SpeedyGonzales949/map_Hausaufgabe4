...
/**
 * This class controls the data flow into model object with the help of {@link RegistrationSystem}
 */
public class Controller {
     ...
     *
     */
    public String register(Course course, String student_id) throws StudentCreditsOverflowException, MaxEnrollmentCourseException, IOException, StudentAlreadyEnrolled {
     ...
     */
    public List<Student> retrieveStudentsEnrolledForACourse(String id){
    ...
    /**
     * this method retrieves a list with all courses from courseRepo {@link RegistrationSystem#courseRepo}
     * @return {@code List<Course>}
     */
    ...
    /**
     * this method creates a new course to  {@link RegistrationSystem#courseRepo}
     ...
     * @throws IOException Input or Output error when using a file
     */
    public String addCourse(String teacher_id,String name,String max_enrollment,String credits) throws IOException {
        Course course=new Course(name,UUID.fromString(teacher_id),Integer.parseInt(max_enrollment),Integer.parseInt(credits));
        boolean check=registrationSystem.addCourse((Teacher) this.registrationSystem.findPerson(UUID.fromString(teacher_id)),course);
        if(check)
            return course.getId().toString();
        return null;
    }
    ...
    /**
     * this method deletes a course from {@link RegistrationSystem#courseRepo}
     ...
     * @throws IOException Input or Output error when using a file
     */
    public void deleteCourse(String course_id,String teacher_id) throws UnAuthorizedDeleteCourseException, IOException {
    ...
    /**
     * this method adds a new Person to the Repo {@link RegistrationSystem#studentRepo,RegistrationSystem#teacherRepo}
     ...
     * @throws IOException Input or Output error when using a file
     */
    public UUID addPerson(String fname, String lname, @NotNull String option) throws IOException {
        if(option.equals("1")){
     ...
     * @throws IOException Input or Output error when using a file
     */
    public void changeCredits(String teacher_id,String course_id,String credits) throws StudentCreditsOverflowException, UnAuthorizedEditCourseException, IOException {
        Course course=this.registrationSystem.findCourse(UUID.fromString(course_id));
        if(course.getTeacher().equals(UUID.fromString(teacher_id)))
    ...
    /**
     * thi methods reads the Data from a file
     * @throws IOException Input or Output error when using a file
     */
    public void readData() throws IOException {
        this.registrationSystem.readData();
    }
